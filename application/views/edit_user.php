                                            ...
                                            <form class="form_register" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <?php 
                                                        $data = $this->db->where("username", $_GET["username"])->get("tbl_profile_pegawai")->result()[0];
                                                        
                                                        ?>
                                                        <fieldset>
                                                            <legend>Data Profil Pegawai</legend>
                                                            <div class="form-group">
                                                                <input class="form-control" type="password" name="password" placeholder="Password" required value="<?php echo $data->password; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="password" name="password2" placeholder="Retype Password" required value="<?php echo $data->password; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nama" placeholder="Nama Beserta Gelar" required value="<?php echo $data->nama ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nip" placeholder="Nip, Jika tidak punya isikan '-' ex: 198501012014011001" max="18" maxlength="18" required value="<?php echo $data->nip ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="tempat_lahir" placeholder="Tempat Lahir" required value="<?php echo $data->tempat_lahir ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control tanggal_lahir" type="" name="tanggal_lahir" placeholder="Tanggal Lahir" required value="<?php echo $data->tanggal_lahir ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nik" placeholder="Nik (Tidak Boleh Kosong)" required value="<?php echo $data->nik ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="npwp" placeholder="Npwp, Contoh: 22.333.444.5-777-000" required value="<?php echo $data->npwp ?>">
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <?php 
                                                        $data = $this->db->where("username", $_GET["username"])->get("tbl_pegawai")->result()[0];
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control datepicker" type="" name="tmt_golongan" required placeholder="Tmt Golongan" value="<?php echo $data->tmt_golongan;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="sk_pengangkatan_awal" required placeholder="Sk Pengangkatan Awal" value="<?php echo $data->sk_pengangkatan_awal;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control tmt_pengangkatan_awal" type="" name="tmt_pengangkatan_awal" placeholder="Tmt pengangkatan awal" required value="<?php echo $data->tmt_pengangkatan_awal;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="mengampu_mata_pelajaran" placeholder="Mengampu Mata Pelajaran" required value="<?php echo $data->mengampu_mata_pelajaran;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="number" name="jumlah_jam_mengajar" placeholder="Jumlah Jam Mengajar, ex: 24" required max="24" value="<?php echo $data->jumlah_jam_mengajar;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="pejabat_yang_mengangkat" placeholder="Pejabat Yang Mengangkat" required  value="<?php echo $data->pejabat_yang_mengangkat;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_sk_cpns" placeholder="No Sk CPNS" required  value="<?php echo $data->no_sk_cpns;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control datepicker" type="" name="tmt_sk_cpns" placeholder="Tmt Sk CPNS" required value="<?php echo $data->tmt_sk_cpns;?>" >
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_sk_pns" placeholder="NO SK PNS" required value="<?php echo $data->no_sk_cpns;?>" >
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control datepicker" type="" name="tmt_sk_pns" placeholder="TMT SK PNS" required  value="<?php echo $data->tmt_sk_pns;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_sk_pangkat_terakhir" placeholder="No Sk Pangkat Terakhir" required  value="<?php echo $data->no_sk_pangkat_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control datepicker" type="" name="tmt_sk_pangkat_terakhir" placeholder="Tmt Sk Pangkat Terakhir" required  value="<?php echo $data->tmt_sk_pangkat_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_nuptk" placeholder="No Nuptk (Jika Tidak Punya Isi '-')" required max="16" value="<?php echo $data->no_nuptk;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_karpeg" placeholder="No Karpeg" required  value="<?php echo $data->no_karpeg;?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="unit_kerja" placeholder="Unit Kerja" required   value="<?php echo $data->unit_kerja;?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input  class="form-control datepicker" type="" name="tmt_jabatan" placeholder="Tmt Jabatan" required  value="<?php echo $data->tmt_jabatan;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="masa_kerja_terakhir" placeholder="Masa Kerja Terakhir" value="8 Tahun 1 Bulan" required  value="<?php echo $data->masa_kerja_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control masa_kerja_pengangkatan" type="" name="masa_kerja_pengangkatan" placeholder="Masa Kerja Pengangkatan" required  value="<?php echo $data->masa_kerja_pengangkatan;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tahun Pensiun
                                                                    <input  class="form-control tahun_pensiun" type="" name="tahun_pensiun" placeholder="Tahun Pensiun" required  value="<?php echo $data->tahun_pensiun;?>">
                                                                </label>
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control gaji_terakhir" type="" name="gaji_terakhir" placeholder="Gaji Terakhir" required  value="<?php echo $data->gaji_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_sertifikasi" placeholder="No Sertifikasi" required  value="<?php echo $data->no_sertifikasi;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="berkala_terakhir" placeholder="Berkala Terakhir" required value="<?php echo $data->berkala_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="tahun_sertifikasi" placeholder="Tahun Sertifikasi" required value="<?php echo $data->tahun_sertifikasi;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="berkala_terakhir" placeholder="Berkala Terkahir" required  value="<?php echo $data->berkala_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_berkala_terakhir" placeholder="No Berkala Terkahir" required value="<?php echo $data->no_berkala_terakhir;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="tanggal_berkala_berikutnya" placeholder="Tanggal Berkala Berikutnya" required value="<?php echo $data->tanggal_berkala_berikutnya;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="" name="no_berkala_berikutnya" placeholder="No Berkala Berikutnya (isi dgn '-')" required value="<?php echo $data->no_berkala_berikutnya;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input  class="form-control" type="number" name="no_hp" placeholder="No Hp" required value="<?php echo $data->no_hp;?>">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <?php 
                                                        $data = $this->db->where("username", $_GET["username"])->get("tbl_pendidikan")->result()[0];
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control"  type="number" name="tahun_lulus" placeholder="Tahun Lulus" required value="<?php echo $data->tahun_lulus;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="riwayat_pendidikan_sd" placeholder="Riwayat Pendidikan Sd" required value="<?php echo $data->riwayat_pendidikan_sd;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="no_ijazah_sd" placeholder="No Ijazah Sd" required value="<?php echo $data->no_ijazah_sd;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Ijazah Sd:
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="riwayat_pendidikan_smp" placeholder="Riwayat Pendidikan SMP" required placeholder="Riwayat Pendidikan SMP" value="<?php echo $data->riwayat_pendidikan_smp;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="no_ijazah_smp" placeholder="No Ijazah SMP" required value="<?php echo $data->no_ijazah_smp;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>
                                                                    Ijazah Smp: 
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="riwayat_pendidikan_sma" placeholder="Riwayat Pendidikan SMA/SMK" required value="<?php echo $data->riwayat_pendidikan_sma;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control"  type="" name="no_ijazah_sma" placeholder="No Pendidikan SMA/SMK" required value="<?php echo $data->no_ijazah_sma;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>
                                                                    Ijazah Sma: 
                                                        ...
                                                        <?php 
                                                        $data = $this->db->where("username", $_GET["username"])->get("tbl_keluarga")->result()[0];
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nama_suami_istri" required placeholder="Nama Suami / Istri" value="<?php echo $data->nama_suami_istri;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nik_suami_istri" required placeholder="Nik Suami Atau Istri 16 digit" value="<?php echo $data->nik_suami_istri;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="jumlah_anak" required placeholder="Jumlah Anak" value="<?php echo $data->jumlah_anak;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nama_anak_pertama" required placeholder="Nama Anak Pertama" value="<?php echo $data->nama_anak_pertama;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nik_anak_pertama" required placeholder="Nik Anak Pertama 16 digit" value="<?php echo $data->nik_anak_pertama;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nama_anak_kedua" required placeholder="Nama Anak Kedua" value="<?php echo $data->nama_anak_kedua;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nik_anak_kedua" required placeholder="Nik Anak Kedua" value="<?php echo $data->nik_anak_kedua;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nama_anak_ketiga" required placeholder="Nama Anak Ketiga" value="<?php echo $data->nama_anak_ketiga;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nik_anak_ketiga" required placeholder="Nik Anak Ketiga" value="<?php echo $data->nik_anak_ketiga;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nama_ayah_kandung" required placeholder="Nama Ayah Kandung" value="<?php echo $data->nama_ayah_kandung;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nik_ayah_kandung" required placeholder="Nik Ayah Kandung" value="<?php echo $data->nik_ayah_kandung;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nama_ibu_kandung" required placeholder="Nama Ibu Kandung" value="<?php echo $data->nama_ibu_kandung;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="nik_ibu_kandung" required placeholder="Nik Ibu Kandung" value="<?php echo $data->nik_ibu_kandung;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="pekerjaan_suami_istri" required placeholder="Pekerjaan Suami Atau Istri" value="<?php echo $data->pekerjaan_suami_istri;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="nip_suami_istri" required placeholder="Nip Suami Atau Istri (18 angka jika tidak punya isi '-')" value="<?php echo $data->nip_suami_istri;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control penghasilan_suami_istri" type="" name="penghasilan_suami_istri" required placeholder="Penghasilan Suami Istri" value="<?php echo $data->penghasilan_suami_istri;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="alamat_rumah" required placeholder="Alamat Rumah" value="<?php echo $data->alamat_rumah;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="desa_kelurahan" required placeholder="Desa Atau Kelurahan" value="<?php echo $data->desa_kelurahan;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="kecamatan" required placeholder="Kecamatan" value="<?php echo $data->kecamatan;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="kabupaten" required placeholder="Kabupaten" value="<?php echo $data->kabupaten;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="" name="provinsi" required placeholder="Provinsi" value="<?php echo $data->provinsi;?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" type="number" name="kode_pos" required placeholder="Kode Pos" value="<?php echo $data->kode_pos;?>">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                ...
                                                <?php 
                                                $data = $this->db->where("username", $_GET["username"])->get("tbl_sekolah")->result()[0];
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input class="form-control" type="" name="nama_sekolah" required placeholder="Nama Sekolah" value="<?php echo $data->nama_sekolah;?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <select class="form-control" name="ruang_keterampilan" required value="<?php echo $data->ruang_keterampilan;?>">
...
if($_POST["media"] == "register")
{
	...
	{
		alert("Dokumen Sertifikasi Diklat Melebihi 1MB");
		die();
	}
	elseif(!preg_match("/image/", $_FILES["dokumen_sertifikat_diklat"]["type"]))
	{
	...
	{
		$dokumen_sertifikat_diklat = "{$this->config->item('base_url')}/dokumen_sertifikat_diklat/{$_FILES["dokumen_sertifikat_diklat"]["name"]}";
	}
	...
	//foto ijazah sd
	if($_FILES["foto_ijazah_sd"]["size"] > 1048576)
	{
	...
	//foto ijazah smp
	if($_FILES["foto_ijazah_smp"]["size"] > 1048576)
	{
	...
	//foto ijazah sma
	if($_FILES["foto_ijazah_sma"]["size"] > 1048576)
	{
	...
	//fiti kartu keluarga
	if($_FILES["foto_kartu_keluarga"]["size"] > 1048576)
	{
	...
	if($sk_pengangkatan_jabatan_fungsional_tertentu == "Kepala Sekolah")
	{
		...
		if($_FILES["foto_dokumen_nuk"]["size"] > 1048576)
		{
		...
		//foto sekolah
		if($_FILES["foto_sekolah"]["size"] > 1048576)
		{
		...
		if($_FILES["foto_dokumen_kegiatan_sekolah"]["size"] > 1048576)
		{
		...
		$query = $this->db->query("select * from tbl_sekolah where username='$_GET[username]' order by id_data_sekolah desc limit 1");
		
		if($query->num_rows() == 0 && $sk_pengangkatan_jabatan_fungsional_tertentu == "Kepala Sekolah")
		{
			$tbl_sekolah["username"] = $_GET["username"];
		...
		if($tbl_profile_pegawai_insert && $tbl_pegawai_insert && $tbl_pendidikan_insert && $tbl_keluarga_insert && $tbl_sekolah_insert)
		{
            ...
            alert("Berhasil Mengedit Semua Data");
			location("admin");
		}else
		{
			alert("Gagal Mengedit Semua Data");
		die();
		}
	}else
	{
		...
		{
            alert("Gagal Menambahkan Semua Data");
			die();
		}
	}
}
